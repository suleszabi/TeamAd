...
CREATE DATABASE IF NOT EXISTS `team_admin` DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
USE `team_admin`;
...
CREATE DATABASE IF NOT EXISTS `user_mg` DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
USE `user_mg`;
